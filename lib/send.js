...
module.exports = (program) => {
  ...
  send
    ...
    .description('sends tokens from account. Note: to send tokens with comment, use "send message" instead.')
  ...
  send
    ...
    .action((address, message, amount) => log.call(api.sendMessage)(address, message, amount));
