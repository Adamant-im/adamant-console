...
exports.getTransactionsInBlockById = async (blockId = requiredParam('blockId')) => (
  exports.getTransactions(`blockId=${blockId}`, 'orderBy=timestamp:desc')
);

exports.getTransactionsInBlockByHeight = async (height = requiredParam('height')) => (
  exports.getTransactions(`fromHeight=${height}`, `and:toHeight=${height}`, 'orderBy=timestamp:desc')
);

exports.getTransactionsReceivedByAddress = async (address = requiredParam('address')) => (
  exports.getTransactions(`recipientId=${address}`, 'and:minAmount=1', 'orderBy=timestamp:desc')
);
